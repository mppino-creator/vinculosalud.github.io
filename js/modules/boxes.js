...
// Muestra la ocupación de boxes para el día de hoy (visible en dashboard de psicólogo y admin)
...
// Modal de gestión de boxes (solo admin)
...
export function saveBox() {
    ...
    // Guardar en Firebase (llamamos a save del módulo principal o directamente)
...
// Función auxiliar para obtener boxes disponibles en una fecha y hora específicas
