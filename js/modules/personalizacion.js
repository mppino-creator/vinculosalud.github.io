...
function updateFooterFromContactInfo() {
    ...
    if (footerPhone) footerPhone.innerText = contactInfo.phone || '+56 9 3209 3724';
...
export function updateContactSection() {
    ...
    if (contactPhone) contactPhone.innerText = contactInfo.phone || '+56 9 3209 3724';
    ...
    if (!document.getElementById('contactModal')) {
        ...
        <div id="contactModal" class="modal">
            <div class="modal-content" style="max-width: 500px;">
                ...
                <div class="form-group"><label>Teléfono</label><input type="text" id="contactPhoneInput" class="filter-input" placeholder="+56 9 3209 3724"></div>
