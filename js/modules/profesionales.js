    ...
    <div id="editMyProfileModal" class="modal" style="display: none;">
        <div class="modal-content" style="max-width: 800px; max-height: 90vh; overflow-y: auto;">
            ...
            <div id="tabSocial" class="profile-tab" style="display: none;">
                ...
                <div class="form-group"><label><i class="fa fa-whatsapp"></i> WhatsApp</label><input type="text" id="editMyWhatsapp" class="filter-input" placeholder="+56 9 3209 3724"></div>
                <div class="form-group"><label><i class="fa fa-phone"></i> Teléfono de contacto</label><input type="text" id="editMyPhone" class="filter-input" placeholder="+56 9 3209 3724"></div>
...
export async function addStaff() {
    ...
    try {
        ...
        const nuevoProfesional = {
            ...
            isAdmin: false,
            isHiddenAdmin: false,
            advanceNotice: advanceNotice ? parseInt(advanceNotice) : 60,
